...
void code_mode()
{
  ...
  while (code_flag != 0)
  {
    ...
    if (start_tile_special != 1)
    {
      if (RFID_Data == "5")
      { //listener =0;

        special_tile = 1;
        start_tile_special = 1;
        ble_serial.print("0x01code0x1d50x04");
      ...
      { special_tile = 1;
        ...
        start_tile_special = 1;
        ble_serial.print("0x01code0x1d10x04");
        while (ack != '1')
        {
          readAck();
          if (ack == 'Z')
      ...
      { special_tile = 1;
        ...
        start_tile_special = 1;
        ble_serial.print("0x01code0x1d60x04");
        while (ack != '6')
        {
          readAck();
          if (ack == 'Z')
      ...
      { special_tile = 1;
        ...
        start_tile_special = 1;
        ble_serial.print("0x01code0x1d70x04");
        while (ack != '7')
        {
          readAck();
          if (ack == 'Z')
      ...
      { special_tile = 1;
        ...
        start_tile_special = 1;
        ble_serial.print("0x01code0x1d40x04");
        while (ack != '4')
        {
          readAck();
          if (ack == 'Z')
      ...
      { special_tile = 1;
        ...
        start_tile_special = 1;
        ble_serial.print("0x01code0x1d80x04");
        while (ack != '8')
        {
          readAck();
          if (ack == 'Z')
      ...
      { special_tile = 1;
        ...
        start_tile_special = 1;
        ble_serial.print("0x01code0x1d20x04");
        while (ack != '2')
        {
          readAck();
          if (ack == 'Z')
      ...
      { special_tile = 1;
        ...
        start_tile_special = 1;
        ble_serial.print("0x01code0x1d30x04");
        while (ack != '3')
        {
          readAck();
          if (ack == 'Z')
...
//         ack='\0';
         ...
         ack='\0';
          ...
          { //listener =0;
            ...
            special_tile = 1;
            ble_serial.print("0x01code0x1240x04");
            while (ack != '2')
            {
              readAck();
              if (ack == 'Z')
          ...
          case 'f':
            ...
            if (((RFID_Data == "FORWARD" && start_flag == 1) || forward_flag == 1 ||
                 ((((prev_mile == 'l' && RFID_Data == "LEFT") || (prev_mile == 'r' && RFID_Data == "RIGHT")) && (RFID_Data != "START" || RFID_Data != "STOP"))
                  && ((left_count < 2 && left_count > 0 ) || (right_count < 2 && right_count > 0)))) || (special_flag == 1) )
            {
        ...
        { prev_mile == '\0';
          //ble_serial.print("0x01code0x1dKI0x04");
