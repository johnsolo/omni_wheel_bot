...
recharge();
  ...
  while (teach_flag != 0)
  {
    ...
    else if (RFID_Data == "1" && start_flag == 1 )
    {
      // working();
      Serial.println("forward");
      // encoder(motorp, motorn, 1, 0, 8,);
      ble_serial.println("0x01teach0x1d10x04");
            readAck();
      if (ack == 'Z')
      { Serial.println("special");
        yellow_color();
    ...
    else if (RFID_Data == "2" && start_flag == 1 )
    {
      // working();
      Serial.println("forward");
      // encoder(motorp, motorn, 1, 0, 8,);
      ble_serial.println("0x01teach0x1d20x04");
            readAck();
      if (ack == 'Z')
      { Serial.println("special");
        yellow_color();
     ...
     else if (RFID_Data == "3" && start_flag == 1 )
    {
      // working();
      Serial.println("forward");
      // encoder(motorp, motorn, 1, 0, 8,);
      ble_serial.println("0x01teach0x1d30x04");
            readAck();
      if (ack == 'Z')
      { Serial.println("special");
        yellow_color();
     ...
     else if (RFID_Data == "4" && start_flag == 1 )
    {
      // working();
      Serial.println("forward");
      // encoder(motorp, motorn, 1, 0, 8,);
      ble_serial.println("0x01teach0x1d40x04");
            readAck();
      if (ack == 'Z')
      { Serial.println("special");
        yellow_color();
      ...
      count1 = 0;
         ...
         else if (RFID_Data == "5" && start_flag == 1 )
    {
      // working();
      Serial.println("forward");
      // encoder(motorp, motorn, 1, 0, 8,);
      ble_serial.println("0x01teach0x1d50x04");
            readAck();
      if (ack == 'Z')
      { Serial.println("special");
        yellow_color();
      ...
      else if (RFID_Data == "6" && start_flag == 1 )
    {
      // working();
      Serial.println("forward");
      // encoder(motorp, motorn, 1, 0, 8,);
      ble_serial.println("0x01teach0x1d60x04");
            readAck();
      if (ack == 'Z')
      { Serial.println("special");
        yellow_color();
      ...
      else if (RFID_Data == "7" && start_flag == 1 )
    {
      // working();
      Serial.println("forward");
      // encoder(motorp, motorn, 1, 0, 8,);
      ble_serial.println("0x01teach0x1d70x04");
            readAck();
      if (ack == 'Z')
      { Serial.println("special");
        yellow_color();
      ...
      else if (RFID_Data == "8" && start_flag == 1 )
    {
      // working();
      Serial.println("forward");
      // encoder(motorp, motorn, 1, 0, 8,);
      ble_serial.println("0x01teach0x1d80x04");
            readAck();
      if (ack == 'Z')
      { Serial.println("special");
        yellow_color();
     ...
     else if (RFID_Data == "&" && start_flag == 1 )
    {
      ...
      Serial.println("forward");
      // encoder(motorp, motorn, 1, 0, 8,);
      ble_serial.println("0x01teach0x1d&0x04");      readAck();
      if (ack == 'Z')
      { Serial.println("special");
        yellow_color();
      }
